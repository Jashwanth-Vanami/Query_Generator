...
class SchemaGenerator:
    ...
    def fetch_schema(self):
        """Fetches the schema and relationships from the MySQL database."""
        ...
        try:
            ...
            # Ensure the database connection is closed after fetching the schema
            self.disconnect_mysql()

    def get_schema(self):
        """Returns the cached schema if available, otherwise fetches a new one."""
        if not self.schema:
